...
@Composable
fun MediumToExpandedGetUserScreen(
    ...
    val keyboardController = LocalSoftwareKeyboardController.current // Controller for the software keyboard
    ...
    val gifSize = (screenWidthDp * 0.35f) // Calculate GIF size based on screen width
    ...
    Row(
        modifier = Modifier
            ...
            .verticalScroll(scrollState) // Make row scrollable
            .padding(LARGE_PADDING), // Add padding
        horizontalArrangement = Arrangement.SpaceAround, // Space elements evenly
        verticalAlignment = Alignment.CenterVertically // Align elements vertically centered
    ) {
        // Box to hold the loading GIF
        Box(
            modifier = Modifier
                .fillMaxHeight() // Fill available height
                .weight(1f), // Take equal weight in row
            ...
            Image(
                ...
                painter = rememberDrawablePainter(
                    drawable = getDrawable(
                        ...
                        R.drawable.github // Load the GIF drawable
                    )
                ),
        ...
        Column(
            modifier = Modifier
                .fillMaxHeight() // Fill available height
                .weight(1f) // Take equal weight in row
                .padding(end = EXTRA_LARGE_PADDING, start = EXTRA_LARGE_PADDING), // Add padding
